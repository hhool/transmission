...
Torrent.prototype =
{
	...
	****/
	...
	getName: function() { return this.fields.name || '未知'; },
	getNameInTable:function() { return utf8to16(base64decode(this.fields.nameintable)) || '未知' ;},
	...
	isPrePareCache:function() { return this.getStatus == Torrent._StatusPrepareCache; },
	...
	getStateString: function() {
		switch(this.getStatus()) {
			case Torrent._StatusStopped:        return this.isFinished() ? '任务完成' : '暂停';
			case Torrent._StatusCheckWait:      return '数据校验排队中';
			case Torrent._StatusCheck:          return '正在校验数据';
			case Torrent._StatusDownloadWait:   return '开始下载排队中';
			case Torrent._StatusDownload:       return '正在下载';
			case Torrent._StatusSeedWait:       return '数据提供排队中';
			case Torrent._StatusSeed:           return '正在提供数据';
			case Torrent._StatusPrepareCache:   return '准备缓存';
			case null:
	...
	testState: function(state)
	{
		...
		switch(state)
		{
			...
			case Prefs._FilterDownloading:
				return (s === Torrent._StatusPrepareCache)
				    || (s === Torrent._StatusDownload)
