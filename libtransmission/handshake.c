 ...
 *
 * $Id: handshake.c 12365 2011-04-17 05:22:50Z jordan $
 */
                ...
                struct evbuffer * inbuf )
{
    ...
    dbgmsg( handshake, "payload: need %d, got %u",
          ...
          struct evbuffer * inbuf )
{
    ...
    dbgmsg( handshake, "pad d: need %u, got %u",
        ...
        struct evbuffer * inbuf )
{
    ...
    dbgmsg( handshake, "in readYa... need %d, have %u",
        ...
        struct evbuffer * inbuf )
{
    ...
    dbgmsg( handshake, "reading IA... have %u, need %u",
                   ...
                   struct evbuffer * inbuf )
{
    ...
    dbgmsg( handshake, "reading payload stream... have %u, need %u",
            evbuffer_get_length( inbuf ), needlen );
    if( evbuffer_get_length( inbuf ) < needlen )
        return READ_LATER;
...
tr_handshakeFree( tr_handshake * handshake )
{
	...
	//tr_inf( "free  handshake->timeout_timer %x", handshake->timeout_timer);
                 ...
                 void                * doneUserData )
{
	...
	//tr_inf( "new  handshake->timeout_timer %x", handshake->timeout_timer);
