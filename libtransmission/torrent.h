...
void        tr_ctorSetDisplayName(tr_ctor * ctor,const char* szNameInTable);

bool		tr_ctorGetDisplayName(const tr_ctor * ctor,char** szNameInTable);
...
void             tr_torrentSetLocalError( tr_torrent * tor,tr_stat_errtype_detail errid, const char * fmt, ... ) TR_GNUC_PRINTF( 3, 4 );
...
struct tr_torrent
{
	...
	bool					   isNewTorrent;
	bool					   isFilesInTorrentExsit;
	bool					   isSureFilesInTor;
    bool                       isRunning;
    bool                       isStopping;
	bool					   isCreating;
    bool                       isDeleting;
