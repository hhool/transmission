...
pgpipe( int handles[2] )
{
    ...
    serv_addr.sin_addr.s_addr = htonl(INADDR_LOOPBACK);//INADDR_LOOPBACK 127.0.0.1
              ...
              void * veh )
{
    ...
    switch( ch )
    {
        ...
        case '\0': /* eof */
        {
			...
			tr_inf( "free eh->pipeEvent %x",eh->pipeEvent );
...
libeventThreadFunc( void * veh )
{
	...
	tr_inf( "new eh->pipeEvent %x",eh->pipeEvent );
