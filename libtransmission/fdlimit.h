...
ssize_t tr_pread(int fd, void *buf, size_t count, long long offset);
ssize_t tr_pwrite(int fd, const void *buf, size_t count, long long offset);
int tr_prefetch(int fd, long long offset, size_t count);
